...
<p align="center">Lead Conversion Process - Demonstrated as a funnel</p>
...
Another thing about the data is that we also need to check out whether there are the levels present in the categorical variables.
...
* Provide recommendations to the company for which leads to contact for better conversion rate.


## Contributers
1. Manushree Jain
2. Harsha Vardhan Tamma
3. Arutla Uma Maheshwar Reddy
